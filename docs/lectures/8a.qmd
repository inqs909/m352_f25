...
|------|---------|-------------|
| **Population Mean** | $\mu$ | True average |
| **Sample Mean** | $\bar{x}$ | Average from a sample |
| **Population Variance** | $\sigma^2$ | True variance |
| **Sample Variance** | $s^2$ | Variance from sample data |
| **Population Proportion** | $p$ | True proportion |
| **Sample Proportion** | $\hat{p}$ | Observed proportion |
